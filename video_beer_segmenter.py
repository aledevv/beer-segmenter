...
import numpy as np
import os
from kmeans import segment_image, find_largest_cluster_contours, merge_contours_outer, find_most_bordering_contour
...
def process_video(video_path, output_path, initial_center, final_center):
    ...
    for step in tqdm(range(frame_count), desc="Elaborazione video", unit="frame"):
        ...
        processed_frame, prev_contour, max_area = process_frame(frame, center, max_area)
